...
<head>
    ...
    <style>
        ...
        main { 
            flex: 1; 
            position: relative; 
            /* Tambahin ini biar daun/pohon gak keluar jalur */
            overflow: hidden; 
        }
...
/* ================= POHON KANAN ================= */
        ...
        footer {
            ...
            margin-top: auto;
            position: relative;
            /* Footer harus di layer paling atas biar nutupin pohon */
            z-index: 50; 
...
<body>
    ...
    <footer class="w-full mt-auto relative">
        ...
        <div class="max-w-6xl mx-auto px-6 py-10 grid grid-cols-3 items-center border-t border-gray-100 relative z-20">
        ...
        <div class="footer-loop relative z-50 bg-white"></div>
    </footer>
