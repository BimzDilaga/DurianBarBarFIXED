...
<body class="bg-white">
    ...
    <main>
        ...
        <!-- SEARCH BOX PENCARIAN PRODUK -->
        <div class="max-w-4xl mx-auto mt-8 px-4 relative z-20">
            <input type="text" id="searchInput" placeholder="Cari produk favoritmu di sini..." 
                class="w-full px-6 py-3 rounded-full border-2 border-gray-200 focus:border-[#39AE1F] focus:ring-2 focus:ring-green-100 outline-none transition shadow-sm font-bold text-[14px]">
        </div>

        <div class="max-w-4xl mx-auto mt-8 mb-20 px-4 relative z-10">
            <div class="bg-green-dark rounded-[40px] p-8 pt-12 relative shadow-xl">
                ...
                <div class="flex flex-col gap-6 mt-4">
                    ...
                    <!-- PRODUCT CARD (Dengan Class Khusus Untuk Search) -->
                    <div class="product-card bg-white rounded-[25px] p-5 flex flex-col md:flex-row gap-6 items-stretch shadow-md hover:-translate-y-1 transition duration-300 relative overflow-hidden">
                        ...
                        <div class="flex-1 flex flex-col justify-between py-1 relative z-0">
                            <div>
                                ...
                                <!-- CLASS DESKRIPSI SUDAH DIPERBAIKI -->
                    ...
                    <div class="bg-white rounded-[25px] p-10 text-center shadow-md">
                        ...
                        <h3 class="text-2xl font-black text-gray-500 uppercase tracking-tighter m-0">Menu belum tersedia.</h3>
                    </div>
                    @endforelse
                </div>
            </div>
    ...
    <!-- MESIN PENCARI OTOMATIS (TERTANAM LANGSUNG BIAR AMAN) -->
    <script>
        var searchInputProd = document.getElementById('searchInput');
        if (searchInputProd) {
            searchInputProd.addEventListener('keyup', function() {
                ...
                productCards.forEach(function(card) {
                    ...
                    if (titleElement) {
                        var cardTitle = titleElement.innerText.toLowerCase();
                        card.style.display = cardTitle.includes(filterText) ? "flex" : "none";
                    }
                });
            });
        }
